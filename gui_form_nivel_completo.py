...
class FormNivelCompleto(Form):
    def __init__(self,config,master_surface,
        ...
        self.titulo = Label(master_form=self, x=ANCHO_FORM/2-ANCHO_LABEL/2, y=30, w=ANCHO_LABEL, h=ALTO_LABEL, text="¡Nivel completo!", font= "Arial", font_size=40, font_color=C_TEXT)
