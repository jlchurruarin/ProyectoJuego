...
class FormMenuPrincipal(Form):
    def __init__(self,config,master_surface,
        ...
        self.btn_continuar = Button(master=self,x=ANCHO_FORM/2-ANCHO_BOTON/2,y=75,w=ANCHO_BOTON,h=ALTO_BOTON,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Comic_Border/Buttons/Button_M_02.png",on_click=self.continuar_nivel,on_click_param="",text="Continuar",font="Verdana",font_size=30,font_color=C_WHITE)
